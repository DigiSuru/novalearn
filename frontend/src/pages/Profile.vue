                   ...
                   <tbody class="divide-y divide-gray-50">
                      ...
                      <tr v-for="note in userNotes" :key="note.id" class="hover:bg-gray-50 transition-colors">
                         ...
                         <td class="p-5 text-right flex justify-end space-x-2">
                            ...
                            <button @click="handleDeleteNote(note.id)" class="p-2 text-gray-400 hover:text-red-600 bg-white border border-gray-200 rounded-lg shadow-sm transition-colors" title="Delete Content">
                ...
                <div v-for="c in allCourses" :key="c.id" class="bg-white p-8 rounded-[2rem] border border-gray-100 shadow-sm relative group overflow-hidden">
                   <div class="relative">
                      ...
                      <div class="mt-8 flex justify-between items-center border-t border-gray-50 pt-4">
                         ...
                         <button @click="handleDeleteCourse(c.id)" class="text-xs font-black text-red-400 hover:text-red-600 uppercase tracking-widest flex items-center">
