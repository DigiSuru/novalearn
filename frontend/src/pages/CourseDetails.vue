      ...
      <div v-if="activeTab === 'discussion'" class="w-full mx-auto animate-in slide-in-from-bottom-4 duration-500 flex flex-col gap-6">
         ...
         <div class="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div class="flex items-center gap-3">
               ...
               <!-- Email -->
               <a href="mailto:suru7392@gmail.com" target="_blank" class="flex items-center justify-center w-10 h-10 rounded-full bg-slate-50 border border-slate-200 text-slate-600 hover:bg-slate-600 hover:text-white transition-all shadow-sm">
                  <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 12.713l11.985-8.71c-.096-1.554-1.378-2.79-2.954-2.79H2.97C1.405 1.213.132 2.433.023 3.973L12 12.713zm0 2.574L0 6.57v13.217c0 1.656 1.344 3 3 3h18c1.656 0 3-1.344 3-3V6.57l-12 8.717z"/></svg>
               </a>
            </div>
         </div>
